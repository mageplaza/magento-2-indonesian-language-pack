...
![Mageplaza Indonesian language pack](https://cdn3.mageplaza.com/media/general/qjWPj1W.png)
...
![Indonesian language pack process](https://progress-bar.dev//?title=completed)
...
```
composer require mageplaza/magento-2-indonesian-language-pack:dev-master mageplaza/module-smtp 
...
## 3. How to Active the Indonesian language pack 
